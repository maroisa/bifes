<template>
    <div class="p-4 max-w-4xl mx-auto text-xl text-sky-800 leading-8">
        <div class="card">
            <h2 class="font-bold text-sky-900">Tentang Bytesfest</h2>
            <p>
        ...
        <div class="bg-white/60 h-10 w-1 m-auto shadow-lg"></div>
        <div class="card">
